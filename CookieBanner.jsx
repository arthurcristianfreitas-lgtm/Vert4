    ...
    <>
      ...
      >
        <div className="cookie-grid" style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 22 }}>
          <div>
            ...
            <p style={{ color: V.muted, fontSize: 14, lineHeight: 1.7, margin: "0 0 14px" }}>
              A VERT4 usa dados de navegação para entender quais partes do diagnóstico geram maior interesse,
              quanto tempo a pessoa permanece na pagina e quais canais de contato são acionados.
            </p>
            ...
            >
              {showDetails ? "Ocultar detalhes" : "Ver dados coletados"}
            </button>
          </div>
        ...
        {showDetails && (
          ...
          >
            Dados coletados: identificador anonimo de sessão, origem de tráfego, horário do evento,
            tempo de permanencia, interações antes do clique, paginas/abas visualizadas e canal de contato acionado.
            Os dados são usados apenas para análise interna e melhoria da experiência, conforme a LGPD.
          </div>
        )}
